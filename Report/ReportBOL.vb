...
Public Class ReportBOL
    ...
    Private Sub BPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BPrint.Click
        Try
            ...
            sql &= "Left Join (select * from T_LOADINGNOTECOMPARTMENT where lc_status in(3,4)) T_LOADINGNOTECOMPARTMENT On T_LOADINGNOTE.LOAD_ID = T_LOADINGNOTECOMPARTMENT.LC_LOAD "
    ...
    Private Sub ReportBOL_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DataSet_View.BOL_Report' table. You can move, or remove it, as needed.
        Me.BOL_ReportTableAdapter.Fill(Me.DataSet_View.BOL_Report)
        'TODO: This line of code loads data into the 'DataSet_View.V_BOL_M1M2_NEW' table. You can move, or remove it, as needed.
        'Me.V_BOL_M1M2_NEWTableAdapter.Fill(Me.DataSet_View.BOL_Report)
