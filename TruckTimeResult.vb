...
Public Class TruckTimeResult
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "RadControlsWinFormsApp1.TruckTimeResult.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTruckTimeResult
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TruckTimeResult = New TruckTimeResult()
        rpt.Site = Me.Site
        Return rpt
    End Function
